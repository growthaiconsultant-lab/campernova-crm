...
> y `updateDeliveryChecklistItem` bloquea la edición en estados terminales. **I3D** (descarte) e **I3E**
> (tasación) siguen **pendientes**. Con I3C3 hay **6 callers productivos** de `withLockedRoots`
> (verificar contra código). La firma ya era obligatoria pre-compleción; lo nuevo en I3C3 es
> validarla/checklist bajo el lock + la guarda terminal de checklist. `LEAD_ARCHIVED` **ya es
