...
> están **fusionados y desplegados**; **I3C3** (compleción coordinada), **I3D** (descarte) e **I3E**
> (tasación) siguen **pendientes**. `createDelivery` y las transiciones/cancelación de entrega **ya
> están coordinadas** con `withLockedRoots` (**5 callers productivos**). `LEAD_ARCHIVED` **ya es
