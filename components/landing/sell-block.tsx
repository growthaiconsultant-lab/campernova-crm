  ...
  return (
    <div className="px-8 max-[640px]:px-5">
      <div className="mx-auto max-w-[1280px]">
        ...
        {/* ── Bloque 2: banner teal oscuro ── */}
        <section className="pb-20">
          <div
            className="overflow-hidden rounded-[24px] px-12 py-14 max-[640px]:px-6 max-[640px]:py-10"
            style={{ background: 'var(--cn-teal-900)' }}
          >
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div>
                ...
                <h2
                  className="mb-5 text-[2rem] font-bold leading-tight tracking-[-0.025em] text-white lg:text-[2.4rem]"
                ...
                >
                  Tasación gratuita, sin compromiso y sin perder una tarde. Cuando quieras vender,
                  ya sabrás cuánto vale.
                </p>
                <Link
                  href="/vender"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3.5 text-[14px] font-semibold text-white transition-opacity hover:opacity-90"
