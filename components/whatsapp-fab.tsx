...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/25 transition-all duration-150 hover:bg-[#20bc5a] active:scale-95"
    >
