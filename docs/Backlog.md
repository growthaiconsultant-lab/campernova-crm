...
### CAM-001 [P0] Setup repositorio y stack base
**Sprint 1**
...
### CAM-002 [P0] Configurar Supabase (Postgres + Auth + Storage)
**Sprint 1**
...
### CAM-003 [P0] Configurar Prisma con schema completo
**Sprint 1**
...
### CAM-004 [P0] Auth con magic link y roles
**Sprint 1**
...
### CAM-005 [P0] Layout backoffice y theme con paleta Campernova
**Sprint 1**
...
### CAM-006 [P0] Seed de 3 usuarios agente
**Sprint 1**
...
### CAM-101 [P0] Form SellerLead + Vehicle en backoffice (canal CN)
**Sprint 2**
...
### CAM-102 [P0] Subida de fotos con drag&drop
**Sprint 2**
...
### CAM-103 [P0] Listado de SellerLeads
**Sprint 2**
...
### CAM-104 [P0] Ficha SellerLead editable
**Sprint 2**
...
### CAM-105 [P0] Form público `/vender` (canal Pro)
**Sprint 2**
...
### CAM-106 [P0] Captcha en form público
**Sprint 2**
...
### CAM-107 [P0] Email confirmación al vendedor (Resend)
**Sprint 2**
...
### CAM-108 [P0] Notificación al agente cuando entra lead
**Sprint 2**
...
### CAM-109 [P0] Asignación/reasignación manual de agente
**Sprint 2**
...
### CAM-201 [P0] Tabla de precios de referencia
**Sprint 3**
...
### CAM-202 [P0] Algoritmo tasación con comparables internos
**Sprint 3**
...
### CAM-203 [P0] Histórico de tasaciones
**Sprint 3**
...
### CAM-204 [P0] Mostrar rango en form Pro y email
**Sprint 3**
...
### CAM-301 [P0] Form BuyerLead en backoffice
**Sprint 3**
...
### CAM-302 [P0] Listado y ficha BuyerLead
**Sprint 3**
...
### CAM-401 [P0] Algoritmo matching v1
**Sprint 3**
...
### CAM-402 [P0] Job recalcular matches
**Sprint 3**
...
### CAM-403 [P0] UI "Ver matches" en fichas
**Sprint 3**
...
### CAM-501 [P0] Estados y transiciones
**Sprint 4**
...
### CAM-502 [P0] Activity log polimórfico
**Sprint 4**
...
### CAM-503 [P0] Notas libres en ficha
**Sprint 4**
...
### CAM-602 [P0] Notificación email match score >70
**Sprint 4**
...
### CAM-603 [P1] Plantillas de mensaje configurables
...
### CAM-604 [P1] Documentos adjuntos en ficha
**Sprint 4 (si hay tiempo)**
...
### CAM-701 [P0] Dashboard con KPIs principales
**Sprint 4**
...
### CAM-901 [P0] Aviso legal, política privacidad, cookies
...
### CAM-902 [P0] Consentimientos en formularios
**Sprint 5**
...
### CAM-1001 [P0] Tests automatizados de flujos críticos
**Sprint 5**
...
### CAM-1006 [P0] Plan post-launch primeros 7 días
**Sprint 5**
